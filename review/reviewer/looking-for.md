...
## 一致性 <a id="consistency"></a>

存量代码的风格是否与风格指南保持一致？根据[代码审核原则](standard.md#principles)，代码风格指南是绝对权威。代码风格指南中明确说明的事项，CL 提交者应该严格遵守。

在代码风格指南中，有些规则的级别是“建议”，而非“必须”。对于这些建议性规则，当规则与存量代码不一致时，开发者可以根据实际情况，自行决定是遵循“建议”的规则，还是与存量代码代码不一致。尽管开发者可以自行决定，我们还是倾向于遵循代码风格指南的建议，除非遵循代码风格造成的局部不一致使代码看起来更紊乱。

如果代码风格指南中尚未提及，代码开发者就应该与存量代码保持一致。

无论如何，都应鼓励开发者提交一个缺陷单或增加一个 TODO 用于修改代码使其更整洁。
